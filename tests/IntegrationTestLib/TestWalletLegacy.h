...
class TestWalletLegacy : private isocoin::IWalletLegacyObserver {
public:
  TestWalletLegacy(System::Dispatcher& dispatcher, const isocoin::Currency& currency, isocoin::INode& node);
  ~TestWalletLegacy();
  ...
  isocoin::IWalletLegacy* wallet();
  isocoin::AccountPublicAddress address() const;
...
private:
  ...
  std::unique_ptr<isocoin::IWalletLegacyObserver> m_walletObserver;
