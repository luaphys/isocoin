...
private:
  std::list<isocoin::Block> m_chain_1;

  isocoin::AccountBase m_recipient_account_1;
  isocoin::AccountBase m_recipient_account_2;
  isocoin::AccountBase m_recipient_account_3;
  isocoin::AccountBase m_recipient_account_4;

  std::vector<isocoin::Transaction> m_tx_pool;
};
