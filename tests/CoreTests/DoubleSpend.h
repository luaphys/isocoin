...
public:
  ...
  bool check_tx_verification_context(const isocoin::tx_verification_context& tvc, bool tx_added, size_t event_idx, const isocoin::Transaction& tx);
  bool check_block_verification_context(const isocoin::block_verification_context& bvc, size_t event_idx, const isocoin::Block& block);

  bool mark_last_valid_block(isocoin::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
  bool mark_invalid_tx(isocoin::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
  bool mark_invalid_block(isocoin::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
  bool check_double_spend(isocoin::core& c, size_t ev_index, const std::vector<test_event_entry>& events);

private:
  isocoin::Block m_last_valid_block;
...
protected:
  ...
  isocoin::AccountBase m_bob_account;
  isocoin::AccountBase m_alice_account;
  isocoin::KeyPair m_outputTxKey;
