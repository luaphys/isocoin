...
namespace {
  ...
  TEST_F(NodeTxPoolSyncTest, TxPoolsAreRequestedRightAfterANodeIsConnectedToAnotherIfTheirBlockchainsAreSynchronized) {
    ...
    std::unique_ptr<isocoin::INode> node0;
    std::unique_ptr<isocoin::INode> node1;
    std::unique_ptr<isocoin::INode> node2;
    std::unique_ptr<isocoin::INode> node3;
    ...
    std::vector<std::unique_ptr<isocoin::ITransactionReader>> poolTxs1;
    std::vector<std::unique_ptr<isocoin::ITransactionReader>> poolTxs2;
  ...
  TEST_F(NodeTxPoolSyncTest, TxPoolsAreRequestedRightAfterTimedBlockchainsSynchronization) {
    ...
    std::unique_ptr<isocoin::INode> node2;
    std::unique_ptr<isocoin::INode> node3;
    std::unique_ptr<isocoin::INode> node4;
    ...
    std::vector<std::unique_ptr<isocoin::ITransactionReader>> poolTxs2;
    std::vector<std::unique_ptr<isocoin::ITransactionReader>> poolTxs3;
    std::vector<std::unique_ptr<isocoin::ITransactionReader>> poolTxs4;
