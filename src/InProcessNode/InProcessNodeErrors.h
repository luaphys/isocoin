...
inline std::error_code make_error_code(isocoin::error::InProcessNodeErrorCodes e) {
  return std::error_code(static_cast<int>(e), isocoin::error::InProcessNodeErrorCategory::INSTANCE);
}
