...
MinerManager::MinerManager(System::Dispatcher& dispatcher, const isocoin::MiningConfig& config, Logging::ILogger& logger) :
...
void MinerManager::startMining(const isocoin::BlockMiningParameters& params) {
...
void MinerManager::adjustBlockTemplate(isocoin::Block& blockTemplate) const {
