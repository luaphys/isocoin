...
namespace isocoin
{
  ...
  /*                                                                      */
  /************************************************************************/
  class simple_wallet : public isocoin::INodeObserver, public isocoin::IWalletLegacyObserver, public isocoin::INodeRpcProxyObserver {
  public:
    simple_wallet(System::Dispatcher& dispatcher, const isocoin::Currency& currency, Logging::LoggerManager& log);
  ...
  private:
    ...
    {
    public:
      refresh_progress_reporter_t(isocoin::simple_wallet& simple_wallet)
    ...
    private:
      isocoin::simple_wallet& m_simple_wallet;
  ...
  private:
    ...
    std::unique_ptr<isocoin::NodeRpcProxy> m_node;
    std::unique_ptr<isocoin::IWalletLegacy> m_wallet;
