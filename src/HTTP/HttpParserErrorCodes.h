...
inline std::error_code make_error_code(isocoin::error::HttpParserErrorCodes e) {
  return std::error_code(static_cast<int>(e), isocoin::error::HttpParserErrorCategory::INSTANCE);
}
