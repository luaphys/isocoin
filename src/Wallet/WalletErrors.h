...
inline std::error_code make_error_code(isocoin::error::WalletErrorCodes e) {
  return std::error_code(static_cast<int>(e), isocoin::error::WalletErrorCategory::INSTANCE);
}

namespace std {

template <>
struct is_error_code_enum<isocoin::error::WalletErrorCodes>: public true_type {};
