...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x2788; // addresses start with "iso"
...
const char     CRYPTONOTE_NAME[]                             = "isocoin";
...
// Network ID - unique to IsoCoin, will not conflict with other CryptoNote coins
