...
std::string get_nix_version_display_string()
{
  ...
  {
    //namespace fs = boost::filesystem;
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\isocoin_NAME
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\isocoin_NAME
    // Mac: ~/Library/Application Support/isocoin_NAME
    // Unix: ~/.isocoin_NAME
    std::string config_folder;
#ifdef WIN32
    // Windows
    config_folder = get_special_folder_path(CSIDL_APPDATA, true) + "/" + isocoin::isocoin_NAME;
#else
    std::string pathRet;
    ...
    config_folder =  (pathRet + "/" + isocoin::isocoin_NAME);
#else
    // Unix
    config_folder = (pathRet + "/." + isocoin::isocoin_NAME);
#endif
