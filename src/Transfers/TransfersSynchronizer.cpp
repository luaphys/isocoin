...
TransfersSyncronizer::TransfersSyncronizer(const isocoin::Currency& currency, IBlockchainSynchronizer& sync, INode& node) :
...
void TransfersSyncronizer::load(std::istream& is) {
  ...
  isocoin::BinaryInputStreamSerializer s(inputStream);
  uint32_t version = 0;
