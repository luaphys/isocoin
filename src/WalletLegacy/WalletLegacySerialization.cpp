...
void serialize(UnconfirmedTransferDetails& utd, isocoin::ISerializer& serializer) {
...
void serialize(WalletLegacyTransaction& txi, isocoin::ISerializer& serializer) {
  ...
  isocoin::serializeBlockHeight(serializer, txi.blockHeight, "block_height");
...
void serialize(WalletLegacyTransfer& tr, isocoin::ISerializer& serializer) {
