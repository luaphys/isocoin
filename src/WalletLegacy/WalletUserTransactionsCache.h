...
public:
  ...
  bool serialize(isocoin::ISerializer& serializer);
  ...
  void updateTransaction(TransactionId transactionId, const isocoin::Transaction& tx, uint64_t amount, const std::list<TransactionOutputInformation>& usedOutputs);
