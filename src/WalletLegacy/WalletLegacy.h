...
public:
  WalletLegacy(const isocoin::Currency& currency, INode& node);
...
private:
  ...
  Tools::ObserverManager<isocoin::IWalletLegacyObserver> m_observerManager;
