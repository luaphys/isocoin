...
public:
  ...
  virtual void notify(Tools::ObserverManager<isocoin::IWalletLegacyObserver>& observer) = 0;
};
...
public:
  ...
  virtual void notify(Tools::ObserverManager<isocoin::IWalletLegacyObserver>& observer) override
  {
